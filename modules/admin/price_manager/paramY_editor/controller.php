<?php 
	...
	foreach($tbl_data as $type => $rows){
		   ...
		   echo '<input type="button"  class="pointer" onclick="priseManagerSendDataToBase(this.form,{\'type\':\'dop_data\',\'param_type\':\'цвет\',\'bufferId\':\'tblDataBuffer'.$type.'0\',\'tblId\':\'tbl'.$type.'0\'});" value="сохранить">';/**/
		   echo '</form>';
		   echo '<br><br><br>';
