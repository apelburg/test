        ...
        <div id="sample_content">
            ...
            <?php
                ...
                FROM
                  ...
                  if($_GET['sample_page']=='history'){
                      $query .= " AND s.manager_id = ".$_SESSION['access']['user_id']." ";
                  }
                            ...
                            echo '<form name="request_samples" id="request_samples_2" action="modules/samples/function_send.php" method="post">
                             ...
                             echo'
                                    <tr>
                                        ...
                                        <td class="sample_note"><input type="text" name="" value="'.$item['note'].'"/></td>
                                    </tr>';
