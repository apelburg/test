...
foreach($mass as $key => $type){
    foreach($mass[$key] as $arr => $name){
        if ($suplier1==1){//выполняется при первом проходе(создает шапку документа)
        	//if(isset($phone) && $phone!=""){$phone=$phone.", ";}
        	$i=1; // счетчик количества товаров в каждой вкладке			
            /*******************************/
            ...
            $w++;
            $i++;
        }else if($suplier1!=$arr && $suplier1!=1){//выолняется при смене поставщика.... то есть когда нужно закрыть старый файл и создать новый(содержит конец и начало файла)
            $i=1; // счетчик количества товаров в каждой вкладке
            /*******************************/
			$q=$w-1;
			/* начало нижней части*/
            ...
            $w++;
            $i++;
        }else if($suplier1==$arr){// выполняется при перечислении списка одного и того же поставщика (тело документа)
            /*******************************/
...
<div class="main_container">
    <table class="main_menu_tbl">
        <tr>
            <td>
                <a href="../../../libs/php/?page=clients&section=clients_list">Клиенты</a>
            </td>
            <td>
                <a href="../../../libs/php/?page=suppliers">Поставщики</a>
            </td>
            <td>
                <a href="../../../libs/php/?page=planner">Планы</a>
            </td>
            <td>
                <a href="../../../libs/php/?page=orders">Заказы</a>
            </td>
             <td>
                <a href="../../../libs/php/?page=documents">Документы</a>
            </td>
            <td>
                <a href="../../../libs/php/?page=samples&sample_page=start">Образцы</a>
            </td>
            <td>
                <a href="../../../libs/php/?page=delivery">Доставка</a>
            </td>
            <td>
                <a href="../../../libs/php/?page=design">Дизайн</a>
            </td>
            <td>
                <a href="../../../libs/php/?page=empty">Производство</a>
            </td>
            <td>
                <a href="../../../libs/php/?page=empty">Уведомления</a>
            </td>
            <td>
                <a href="../../../libs/php/?page=empty">Ещё</a>
            </td>
            <td style="width:auto;">&nbsp;
                        ...
                        <td style="padding:0px 2px;">
                            ...
                            <div class="authentication_menu_container">
                               <div class="authentication_menu_div" id="authentication_menu_div">
                                    ...
                                    <div class="cap2"><nobr><a href="../../../libs/php/?out">выйти из приложения <!--<span class="cross">&#215</span>--></a></nobr></div>
    ...
    <table class="quick_panel_tbl">
        <tr>
            ...
            <?php
            if(isset($_GET['page']) && $_GET['page']=='samples'){
            echo '<input type="button" onclick="submitform(\'request_samples\')" name="request_samples" style="border: 1px solid #9f9e9d; background:white; color:grey; padding:2px; margin-left:8%;cursor:pointer;box-shadow: 0 2px 5px black;" value="запроить образцы">';
            }else{
