<!-- begin skins/tpl/sample/show.tpl --> 
    ...
    <div id="sample_content">
            ...
            <div>
                <table>
                    <thead>
                        <tr>
                            <td width="2%"></td>
                            <td class="sample_num_rows_check" width="2%"><input type="checkbox" id="checkbox_all" name="" onClick="check_all(this);"><label for="checkbox_all"></label></td>
                            <?php                    
        ...
        $price = '0';
            ...
            FROM
              ...
              WHERE s.stage = 0 AND s.manager_id = ".$_SESSION['access']['user_id']."
                ORDER BY `s`.`$sort` ASC
                ";
			//echo $query;
            ...
            if(mysql_num_rows($result) > 0){
                    ...
                    if(isset($_GET['sort']) && $_GET['sort']=='client'){
                        ...
                        echo '<form name="request_samples" id="request_samples" action="modules/samples/function_pdf.php" method="post">
                         ...
                         echo'
                                <tr>
                                    ...
                                    <td width="6%" class="sample_num_rows_unit">
                                        <select name="s_'.$item['id_n'].'">
                                        <option value="1">1</option>
                                        <option value="2">2</option>
                                        <option value="3">3</option>                            
                                        </select>
                                    </td>
                                    <td width="6%" class="sample_summ">'.$price.' р</td>
                                    <td width="6%" class="sample_summ">'.$price.' р</td>
