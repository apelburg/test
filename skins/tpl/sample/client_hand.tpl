            ...
            <div>
                <table>
                    <thead>
                        <tr>
                            <td width="2%"></td>
                            <td class="sample_num_rows_check" width="2%"><input id="checkbox_all" type="checkbox" name="" onChange="check_all_for_request(this);"><label for="checkbox_all"></label></td>
                            <?php                    
        ...
        <?php
           ...
           `s`.`id` AS `id_n`,
            ...
            FROM
              ...
              WHERE s.stage = 5 AND s.manager_id = ".$_SESSION['access']['user_id']."
                ORDER BY `s`.`$sort` ASC
                ";
			//echo $query;
                    ...
                    if(isset($_GET['sort']) && $_GET['sort']=='client'){
                        ...
                        echo '<form name="request_samples" id="request_samples_2" action="modules/samples/function_send.php" method="post">
                            ...
                            <thead>
                                <tr>
                                    <td width="2%"></td>
                                    <td  class="sample_num_rows_check" width="2%"><input type="checkbox" id="check_table_'.$table.'" name="" onClick="'.$check_on_for_request.';"><label for="check_table_'.$table.'"></label></td>
                           ...
                           <tbody>';
                            ...
                            $disabled = 'disabled';
                            $stage_b = 'style="background:#03981D;"';//возврат
                            }else{
                            	$stage_b = '';
                                $disabled = '';
                            }
                         echo'
                                <tr>
                                    ...
                                    <td class="sample_num_rows_check"><input type="checkbox" id="check_'.$item['id_n'].'" name="c_'.$item['id_n'].'" onChange="'.$greate_row_driver_list.'"><label for="check_'.$item['id_n'].'"></label><input type="hidden" value="'.$item['supplier_id'].'" class="suplier_hidden"><input type="hidden" value="'.$item['nickName'].'" class="suplier_nickName_hidden"></td>
                        ...
                        echo'
                                <tr>
                                    <td class="sample_num_rows">'.$count.'</td>
                                    <td class="sample_num_rows_check"><input type="checkbox" id="check_'.$item['id_n'].'" name="c_'.$item['id_n'].'" onChange="greate_row_driver_list(this)"><label for="check_'.$item['id_n'].'"></label><input type="hidden" value="'.$item['supplier_id'].'" class="suplier_hidden"><input type="hidden" value="'.$item['nickName'].'" class="suplier_nickName_hidden"></td>
                                    <td width="10%">'.$in_table.'</td>
                                    <td width="9%" onclick="img_show_togle(this)" class="td_togle">'.$item['art'].'<div><img src="'.$img_catalog.$img_arr[$item['art']]['small'].'"></div></td>
                                    <td width="30%">'.$item['name'].'</td>
                                     <td width="6%" class="sample_num_rows_unit">
                        ...
                        <table id="table_'.$table.'">
                         ...
                         echo'
                                <tr>
                                    <td class="sample_num_rows">'.$count.'</td>
                                    <td class="sample_num_rows_check"><input type="checkbox" id="check_'.$item['id_n'].'" name="c_'.$item['id_n'].'" onChange="greate_row_driver_list(this)"><input type="hidden" value="'.$item['supplier_id'].'" class="suplier_hidden"><input type="hidden" value="'.$item['nickName'].'" class="suplier_nickName_hidden"><label for="check_'.$item['id_n'].'"></label></td>
                                    <td width="10%">'.$in_table.'</td>
                                    <td width="9%" onclick="img_show_togle(this)" class="td_togle">'.$item['art'].'<div><img src="'.$img_catalog.$img_arr[$item['art']]['small'].'"></div></td>
                                    <td width="30%">'.$item['name'].'</td>
                                    <td width="6%" class="sample_num_rows_unit">
