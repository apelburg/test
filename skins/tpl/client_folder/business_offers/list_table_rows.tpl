<tr>
     ...
     <td class="center without_padding"><a href="http://<?=$_SERVER['HTTP_HOST'];?>/os/?page=client_folder&amp;client_id=<?=$_GET['client_id'];?>&amp;query_num=<?=$query_num;?>" style="text-decoration: underline;"><?php  echo $query_num; ?></a></td>
