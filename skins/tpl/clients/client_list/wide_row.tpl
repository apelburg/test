<tr class="noselect">
    <td class="edge">&nbsp;</td>
    <td class="name"><div><a href="?page=cabinet&section=requests&subsection=no_worcked_men&client_id=<?php echo $item['id']; ?>" target="_blank"><?php echo '33'.$item['company']; ?></a></div></td>
    <td class="rating">
