<tr>
     ...
     <td class="without_padding_all">
         <table class="options_tbl">
             <tr>
                 ...
                 <td><a href='#'>напечатать</a></td>
                 <td><a href='#'>письмо</a></td>
             </tr>
         </table>
   ...
   <td class="<?php  echo $comment_style; ?>">
       <div managed="text" file_name="<?php echo $file; ?>" file_exicution="change_file_comment" when_done="set_color">
           <?php  echo $comment; ?>
       </div>
   ...
   <td class="center italic grey">
       <a href='?page=clients&section=client_folder&subsection=business_offers&client_id=<?php  echo $client_id; ?>&delete_com_offer=<?php  echo urlencode($file); ?>&id=<?php  echo $com_pred_data["id"]; ?>' onclick='if(confirm(" Внимание! КП будет удалено!\r\n Вы действительно хотите удалить КП?")){ return true;} else{ return false;}'>DEL</a>
   </td>
   <td class="flank_cell">&nbsp;</td>
</tr>