...
<div id="chief_fields_div">
  ...
  <table class="client_form_table" id="chief_fields_tbl">      
    <tr>
            ...
            <td colspan="3">
              <input type="radio" field_type="acting" name="acting" value="<?php echo $contact['acting']; ?>" onclick="drop_radio_buttons(this,'field_type','acting');this.value = '1';"> Лицо, подписывающее договор  
              <input type="hidden" field_type="id" name="form_data[managment1][1][id]" value="<?php echo $contact['id']; ?>">
              <input type="hidden" field_type="requisites_id" name="form_data[managment1][1][requisites_id]" value="<?php echo $contact['requisites_id']; ?>">
              <input type="hidden" field_type="type" name="form_data[managment1][1][type]" value="<?php echo $contact['type']; ?>">
           </td>
    </tr>
        <tr>
        ...
        <div class="note_div" style="margin:22px 0 0 3px; ">
          ...
          <td width="10%">На основании</td>
            <td width="23%">
                <input type="text" name="form_data[managment1][1][basic_doc]" value="<?php echo $contact['basic_doc']; ?>">
                <div class="note_div">
    ...
    <tr>
            ...
            <td width="220">
                <input type="text" name="form_data[managment1][1][name]" value="<?php echo $contact['name']; ?>">
                <div class="note_div">
            ...
            <td width="220">
                <input type="text" name="form_data[managment1][1][name_in_padeg]" value="<?php echo $contact['name_in_padeg']; ?>">
                <div class="note_div">
